    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6 text-white">
      ...
      {loading ? (
        ...
        <div className="border border-dashed border-white/10 rounded-2xl p-12 text-center bg-[#0d0d14]/40">
          ...
          <h3 className="font-semibold text-white/80">No contacts found</h3>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/[0.06] bg-white/[0.02]">
                  ...
                  <th className="p-4 text-xs font-semibold text-white/40 uppercase tracking-wider">Registered</th>
                  <th className="p-4 text-xs font-semibold text-white/40 uppercase tracking-wider">Attended</th>
                  <th className="p-4 text-xs font-semibold text-white/40 uppercase tracking-wider">Total Watch Time</th>
                  <th className="p-4 text-xs font-semibold text-white/40 uppercase tracking-wider">History</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/[0.04]">
                {filtered.map((member, idx) => (
                  <tr key={`${member.email}-${idx}`} className="hover:bg-white/[0.02] transition-colors">
                    <td className="p-4">
